...
def main():
  ...
  Sensor_Data = {
    cst.I2C_ADDRESS[0] : {'Temperature' : -1.0, 'Sample_Num' : 0},
    cst.I2C_ADDRESS[1] : {'Temperature' : -1.0, 'Sample_Num' : 0}
  }
  ...
  try:
    ...
    while True:         # boucle infinie
      ...
      for adr in cst.I2C_ADDRESS:
        Sensor_Data[adr]['Temperature'] = read_Temp(bus, adr)
      ...
      print("\n<Temps: ", temps, ">")
      for adr in cst.I2C_ADDRESS:
        print("Noeud: {0}, Échantillon: {1}, Température: {2:.2f}".format(hex(adr),
        Sensor_Data[adr]['Sample_Num'], Sensor_Data[adr]['Temperature']))
